...
re_devau_size = [51,2]
re_exp_size = [61,2]
catalog = np.zeros([int((re_devau_size[0]-1)*(re_exp_size[0]-1)*(1-0)/(re_devau_size[1]*re_exp_size[1]*0.1)),4]) # in order of ellip,re_devau,re_exp,B/T,re_total
# catalog = np.zeros(5)
catalog_count = 0
brightness = 100
# for BT_ratio in np.arange(0.65,1.01,0.05):
...
# table.writeto(export_path+'equation/B2T_equation.fits',overwrite=True)
# print('CATALOG done')